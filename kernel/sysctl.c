...
static struct ctl_table vm_table[] = {
	...
	{
		.procname	= "fraginfo_enable",
		.data		= &fraginfo_enabled,
		.maxlen		= sizeof(fraginfo_enabled),
		.mode		= 0644,
		.proc_handler	= fraginfo_enable_sysctl_handler,
		.extra1		= &zero,
	},
#ifdef CONFIG_HSWAP
	{
   ...
   (defined(CONFIG_SUPERH) && defined(CONFIG_VSYSCALL))
	...
	{
		.procname	= "adaptive_readahead_upper_limit",
		.data		= &sysctl_a_ra_upper_limit,
		.maxlen		= sizeof(int),
		.mode		= 0644,
		.proc_handler	= proc_dointvec_minmax,
		.extra1		= &zero,
	...
	{
		.procname	= "adaptive_readahead_lower_limit",
		.data		= &sysctl_a_ra_lower_limit,
		.maxlen		= sizeof(int),
		.mode		= 0644,
		.proc_handler	= proc_dointvec_minmax,
		.extra1		= &zero,
	...
	{
		.procname	= "adaptive_readahead_reset_ra_state_cnt",
		.data		= &sysctl_a_ra_reset_state_cnt,
		.maxlen		= sizeof(int),
		.mode		= 0644,
		.proc_handler	= proc_dointvec_minmax,
		.extra1		= &zero,
