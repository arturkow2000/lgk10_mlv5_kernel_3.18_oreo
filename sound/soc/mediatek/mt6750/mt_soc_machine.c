	 ...
	 },
	{
	 ...
	 .ops = &mt_machine_audio_ops,
...
#ifdef CONFIG_INPUT_EPACK
         {
          ...
          .cpu_dai_name = "max98925-aif1",
          .platform_name = MT_SOC_ROUTING_PCM,
          .codec_dai_name = "max98925-aif1",
          .codec_name = "max98925.4-0031",
          .init = mt_soc_audio_init,
          .ops = &mt_machine_audio_ops,
         },
#endif
...
#if defined (CONFIG_SND_SOC_ES9218P) || defined(CONFIG_SND_SOC_AK4376)
static struct snd_soc_dai_link dai_links[ARRAY_SIZE(mt_soc_dai_common)
#ifdef CONFIG_SND_SOC_ES9218P
...
{
	int len = ARRAY_SIZE(mt_soc_dai_common);
	memcpy(dai_links, mt_soc_dai_common, sizeof(mt_soc_dai_common));

#ifdef CONFIG_SND_SOC_ES9218P
	if (of_find_compatible_node(NULL, NULL, "dac,es9218-codec")) {
		memcpy(dai_links + len, mt_soc_dai_es9218, sizeof(mt_soc_dai_es9218));
	...
	if (of_find_compatible_node(NULL, NULL, "akm,ak4376")) {
		memcpy(dai_links + len, mt_soc_dai_ak4376, sizeof(mt_soc_dai_ak4376));
