...
static struct hifi_gpio_attr hifi_gpios[PINCTRL_HIFI_NUM] = {
...
#endif
		if(hifi_gpios[PINCTRL_HIFI_RESET_ON].gpioctrl != NULL)
...
#endif
		if(hifi_gpios[PINCTRL_HIFI_RESET_OFF].gpioctrl != NULL)
...
static DEVICE_ATTR(reg_data, S_IWUSR|S_IRUGO, reg_data_show, reg_data_store);
...
int ak4376_hw_params_dl1(struct snd_pcm_substream *substream, struct snd_pcm_hw_params *params)
{
...
EXPORT_SYMBOL(ak4376_hw_params_dl1);
...
#endif
	if(hifi_gpios[PINCTRL_POWER_LDO_ON].gpioctrl != NULL) {
