		...
		struct inet6_dev *idev, struct ipv6_devconf *p)
{
	...
	/* 2018-02-20 shsh.kim@lge.com LGP_DATA_ENV_MODIFICATION_BY_MTK [START] */
	if(!strncmp(dev_name, "ccmni", 5)) {
		p->rtr_solicits = MAX_RTR_SOLICITATIONS_MOBILE;
	}
	/* 2018-02-20 shsh.kim@lge.com LGP_DATA_ENV_MODIFICATION_BY_MTK [END] */
