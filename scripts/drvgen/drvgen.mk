...
DTS_LIST := $(addprefix $(LGE_DTB_DIR), $(LGE_DTS_FILES))
DTB_FILES := $(addprefix $(objtree)/arch/$(SRCARCH)/boot/dts/, $(DTB_LIST))
DTS_FILES := $(addprefix $(srctree)/arch/$(SRCARCH)/boot/dts/, $(DTS_LIST))
else
