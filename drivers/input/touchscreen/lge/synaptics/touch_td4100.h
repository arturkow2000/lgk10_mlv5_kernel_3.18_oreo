...
#define SWIPE_REPORT_ENABLE		(d->f51.dsc.data_base + 104)
#define SWIPE_ACTIVE_AREA		(d->f51.dsc.data_base + 111)
#define SWIPE_START_AREA		(d->f51.dsc.data_base + 119)
#define SWIPE_WRONG_TH			(d->f51.dsc.data_base + 127)
...
#define SWIPE_FAIL_COUNT_REG		(d->f51.dsc.data_base + 75)
#define SWIPE_FAIL_INDEX_REG		(d->f51.dsc.data_base + 76)
#define SWIPE_FAIL_BUFFER_REG		(d->f51.dsc.data_base + 77)
