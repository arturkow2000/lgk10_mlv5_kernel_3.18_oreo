...
extern unsigned int primary_display_changing;
...
/*Added 6more registers since CV3*/
...
struct lg4894_swipe_ctrl {
	u32 mode;
	struct lg4894_swipe_info info;
};
...
struct lg4894_data {
	...
	struct lg4894_swipe_ctrl swipe;
