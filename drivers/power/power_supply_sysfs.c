...
static ssize_t power_supply_show_property(struct device *dev,
	...
	static char *charge_type[] = {
		...
		"Unknown", "N/A", "0 Dischg", "Trickle", "3 Fast", "6 EoC"
#else
...
static struct device_attribute power_supply_attrs[] = {
	...
	POWER_SUPPLY_ATTR(fastchg_enabled),
	POWER_SUPPLY_ATTR(fastchg_support),
#ifdef CONFIG_LGE_PM_CHARGER_CONTROLLER
	POWER_SUPPLY_ATTR(network_mode),
	POWER_SUPPLY_ATTR(network_charging),
	...
	POWER_SUPPLY_ATTR(game_fcc_main_limit),
	POWER_SUPPLY_ATTR(game_fcc_sub_limit),
#endif
	...
	POWER_SUPPLY_ATTR(charger_dump),
