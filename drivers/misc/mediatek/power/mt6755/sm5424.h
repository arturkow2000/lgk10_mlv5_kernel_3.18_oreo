...
/******************************************************************************/
extern int sm5424_dump_register(void);
extern int sm5424_pe_plus_ta_pattern_increase(void);
extern int sm5424_pe_plus_ta_pattern_decrease(void);
extern int sm5424_pe_plus_20_ta_pattern_increase(void);
extern int sm5424_pe_plus_20_ta_pattern_decrease(void);
extern int sm5424_set_FASTTIMER_timer(int enable);
extern int sm5424_set_otg_boost_enable(int enable);
