...
#define BQ25898S_ENILIM_MASK		0x40
#define BQ25898S_ENILIM_SHIFT		6
#define BQ25898S_ILIM_ENABLE		1
#define BQ25898S_ILIM_DISABLE		0
...
#define BQ25898S_STAT_DIS_MASK		0x40
#define BQ25898S_STAT_DIS_SHIFT		6
#define BQ25898S_STAT_ENABLE		0
#define BQ25898S_STAT_DISABLE		1
...
#define BQ25898S_Q4_MASK		0x20
#define BQ25898S_Q4_SHIFT		5
#define BQ25898S_Q4_ENABLE		0
#define BQ25898S_Q4_DISABLE		1
...
extern int bq2589x_dump_register(void);
extern void bq2589x_adapter_out_handler(void);
extern void bq2589x_adapter_in_handler(void);
extern int bq2589x_set_ibat(int curr);
extern bool bq25898s_charger_en;
#endif
