...
unsigned int bright_arr[] = {
    ...
    1370, 1382, 1394, 1406, 1418, 1430, 1442, 1454, 1466, 1478, 1490, 1502, 1514, 1526, 1538, 1625
};
...
int chargepump_set_backlight_level(unsigned int level)
{
    ...
    if (level) {
        ...
        if (is_suspend == ENABLE){
            ...
            // BL_FREQ : 500KHZ, BL_TRAN : 500us, PWM_FREQ : 4MHZ, PWM_HYST : 1bit
            reg_data = 0x0C;
            dw8767_smbus_write_byte(new_client, 0x03, &reg_data);
