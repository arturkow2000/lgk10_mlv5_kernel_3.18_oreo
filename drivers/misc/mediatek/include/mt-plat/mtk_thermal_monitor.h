...
#ifdef CONFIG_LGE_PM
extern void lge_set_max_brightness(int max_level);
extern void lge_set_brightness(int max_level);
extern int get_max_brightness(void);
extern int get_brightness(void);
extern void thermald_status_update(int enable);
extern void release_max_brightness_by_user(int enable);
#endif
