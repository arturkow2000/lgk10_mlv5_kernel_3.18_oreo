...
extern void DW9763AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock,
				  int *pAF_Opened);
...
extern void DW9763AF_1C_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock,
				  int *pAF_Opened);
...
#ifdef CONFIG_MTK_LENS_DW9768AF_SUPPORT
...
extern void DW9768AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock,
				  int *pAF_Opened);
...
#define ZC533AF_SetI2Cclient ZC533AF_SetI2Cclient_Main
#define ZC533AF_Ioctl ZC533AF_Ioctl_Main
#define ZC533AF_Release ZC533AF_Release_Main
extern void ZC533AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock,
				 int *pAF_Opened);
extern long ZC533AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			  unsigned long a_u4Param);
extern int ZC533AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
#endif

#ifdef CONFIG_MTK_LENS_ZC524AF_SUPPORT
...
extern void ZC524AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock,
				 int *pAF_Opened);
...
extern void ZC535AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock,
				 int *pAF_Opened);
