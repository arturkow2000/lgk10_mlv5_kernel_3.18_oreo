...
#if defined(CONFIG_LGE_LEDS_BREATHMODE)
extern void mt_mt65xx_breath_mode(unsigned int patternid);
extern void mt_mt65xx_breath_mode_2(int freq, int duty, int trf, int ton,int toff);
...
extern void lm3632_set_led_mode(int mode);
extern int rt4832_chargepump_set_backlight_level(unsigned int level);
extern int lm3632_chargepump_set_backlight_level(unsigned int level);
#endif
...
extern void dw8767_set_led_mode(int mode);
#endif
