...
typedef enum {
	...
	CAM_FLASH_EN,
	CAM_FLASH_TX,
    CAM_FLASH_FRONT_EN,//[LGE_UPDATE][kyunghun.oh@lge.com][2016-10-25] ADD FRONT FLASH
	FRONT_POWERS,//[LGE_UPDATE][kyunghun.oh@lge.com][2017-11-28] ADD FRONT POWERS controlled by GPIO
    AVDD_LDO,
    DVDD_LDO,
    DOVDD_LDO 
} PowerType;
...
#define GPIO_SUB_DVDD  4
#define GPIO_SUB_AVDD 10
#define GPIO_SUB_DOVDD 12
