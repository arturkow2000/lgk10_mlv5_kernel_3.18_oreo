...
static imgsensor_info_struct imgsensor_info = { 
	.sensor_id = HI556_SENSOR_ID_QT_MAIN,//Sensor ID Value: 0x30C8//record sensor id defined in Kd_imgsensor.h
	/* HI556_SENSOR_ID_QT_MAIN is configed as 0x556 in kd_imgsensor.h */
  ...
  .custom5 = {
	...
	.i2c_addr_table = {0x50, 0xff},//record sensor support all write id addr, only supprt 4must end with 0xff
