...
#define LOG_DEBUG(format, args...)	pr_err(PFX "[%s] " format, __FUNCTION__, ##args) /*LGE_CHANGE, 2017-12-11, added camera log, soojong.jin@lge.com*/

#define Hi846_MaxGain 16
// [LGE_UPDATE_S] [kyunghun.oh@lge.com] [2017-09-18] Creation of node for camera module identification.
extern int iReadReg(u16 a_u2Addr, u8 *a_puBuff, u16 i2cId);
extern char front_sensor_name[20];
extern int g_mainSensor; 
// [LGE_UPDATE_E] [kyunghun.oh@lge.com] [2017-09-18] Creation of node for camera module identification.
...
static imgsensor_info_struct imgsensor_info = {
	...
	.margin = 6,
	.min_shutter = 2, //[jk.ra@lge.com] [2017-09-28] modified minimum line count for HI846.
...
// [LGE_UPDATE_S] [kyunghun.oh@lge.com] [2017-09-18] Creation of node for camera module identification.
static int hi846_read_eepromVendorID(void)
{
/*
    int retry = 3;
    u8 vendorID_readFrom_front_imageSensor = 1;
    for(; retry > 0; retry--) {
        if(iReadReg(0x0000, &vendorID_readFrom_front_imageSensor, 0xa0) == 0)
            break;
        mdelay(1);
    }
    printk("[hi846_read_eepromVendorID] read eeprom id = %d\n", vendorID_readFrom_front_imageSensor);
    if(vendorID_readFrom_front_imageSensor != 0x01)
    {
        printk("[hi846_read_eepromVendorID] matching fail!! It should be 0x01 but read %d\n", vendorID_readFrom_front_imageSensor);
        return -1;
    }
    else
    {
        printk("[hi846_read_eepromVendorID] matching OK\n");
        strcpy(front_sensor_name, "sl846_lgit");
        return 0;
    }
*/
        strcpy(front_sensor_name, "sl846_lgit");
...
static void sensor_init(void)
{
    ...
    write_cmos_sensor(0x20AA, 0x12B0);
    write_cmos_sensor(0x20AC, 0xFDF4);
    write_cmos_sensor(0x20AE, 0x93C2);
    write_cmos_sensor(0x20B0, 0x829F);
    write_cmos_sensor(0x20B2, 0x2421);
    write_cmos_sensor(0x20B4, 0x403E);
    write_cmos_sensor(0x20B6, 0xFFFE);
    write_cmos_sensor(0x20B8, 0x40B2);
    write_cmos_sensor(0x20BA, 0xEC78);
    write_cmos_sensor(0x20BC, 0x831A);
    write_cmos_sensor(0x20BE, 0x40B2);
    write_cmos_sensor(0x20C0, 0xEC78);
    write_cmos_sensor(0x20C2, 0x831C);
    write_cmos_sensor(0x20C4, 0x40B2);
    write_cmos_sensor(0x20C6, 0xEC78);
    write_cmos_sensor(0x20C8, 0x831E);
    write_cmos_sensor(0x20CA, 0xB3D2);
    write_cmos_sensor(0x20CC, 0x008C);
    write_cmos_sensor(0x20CE, 0x2405);
    write_cmos_sensor(0x20D0, 0x4E0F);
    write_cmos_sensor(0x20D2, 0x503F);
    write_cmos_sensor(0x20D4, 0xFFD8);
    write_cmos_sensor(0x20D6, 0x4F82);
    write_cmos_sensor(0x20D8, 0x831A);
    write_cmos_sensor(0x20DA, 0x90F2);
    write_cmos_sensor(0x20DC, 0x0003);
    write_cmos_sensor(0x20DE, 0x008C);
    write_cmos_sensor(0x20E0, 0x2401);
    write_cmos_sensor(0x20E2, 0x4130);
    write_cmos_sensor(0x20E4, 0x421F);
    write_cmos_sensor(0x20E6, 0x831A);
    write_cmos_sensor(0x20E8, 0x5E0F);
    write_cmos_sensor(0x20EA, 0x4F82);
    write_cmos_sensor(0x20EC, 0x831C);
    write_cmos_sensor(0x20EE, 0x5E0F);
    write_cmos_sensor(0x20F0, 0x4F82);
    write_cmos_sensor(0x20F2, 0x831E);
    write_cmos_sensor(0x20F4, 0x3FF6);
    write_cmos_sensor(0x20F6, 0x432E);
    write_cmos_sensor(0x20F8, 0x3FDF);
    write_cmos_sensor(0x2116, 0x421F);
    write_cmos_sensor(0x2118, 0x7100);
    write_cmos_sensor(0x211A, 0x4F0E);
    write_cmos_sensor(0x211C, 0x503E);
    write_cmos_sensor(0x211E, 0xFFD8);
    write_cmos_sensor(0x2120, 0x4E82);
    write_cmos_sensor(0x2122, 0x7A04);
    write_cmos_sensor(0x2124, 0x421E);
    write_cmos_sensor(0x2126, 0x831A);
    write_cmos_sensor(0x2128, 0x5F0E);
    write_cmos_sensor(0x212A, 0x4E82);
    write_cmos_sensor(0x212C, 0x7A06);
    write_cmos_sensor(0x212E, 0x0B00);
    write_cmos_sensor(0x2130, 0x7304);
    write_cmos_sensor(0x2132, 0x0050);
    write_cmos_sensor(0x2134, 0x40B2);
    write_cmos_sensor(0x2136, 0xD081);
    write_cmos_sensor(0x2138, 0x0B88);
    write_cmos_sensor(0x213A, 0x421E);
    write_cmos_sensor(0x213C, 0x831C);
    write_cmos_sensor(0x213E, 0x5F0E);
    write_cmos_sensor(0x2140, 0x4E82);
    write_cmos_sensor(0x2142, 0x7A0E);
    write_cmos_sensor(0x2144, 0x521F);
    write_cmos_sensor(0x2146, 0x831E);
    write_cmos_sensor(0x2148, 0x4F82);
    write_cmos_sensor(0x214A, 0x7A10);
    write_cmos_sensor(0x214C, 0x0B00);
    write_cmos_sensor(0x214E, 0x7304);
    write_cmos_sensor(0x2150, 0x007A);
    write_cmos_sensor(0x2152, 0x40B2);
    write_cmos_sensor(0x2154, 0x0081);
    write_cmos_sensor(0x2156, 0x0B88);
    write_cmos_sensor(0x2158, 0x4392);
    write_cmos_sensor(0x215A, 0x7A0A);
    write_cmos_sensor(0x215C, 0x0800);
    write_cmos_sensor(0x215E, 0x7A0C);
    write_cmos_sensor(0x2160, 0x0B00);
    write_cmos_sensor(0x2162, 0x7304);
    write_cmos_sensor(0x2164, 0x022B);
    write_cmos_sensor(0x2166, 0x40B2);
    write_cmos_sensor(0x2168, 0xD081);
    write_cmos_sensor(0x216A, 0x0B88);
    write_cmos_sensor(0x216C, 0x0B00);
    write_cmos_sensor(0x216E, 0x7304);
    write_cmos_sensor(0x2170, 0x0255);
    write_cmos_sensor(0x2172, 0x40B2);
    write_cmos_sensor(0x2174, 0x0081);
    write_cmos_sensor(0x2176, 0x0B88);
    write_cmos_sensor(0x2178, 0x9382);
    write_cmos_sensor(0x217A, 0x7112);
    write_cmos_sensor(0x217C, 0x2402);
    write_cmos_sensor(0x217E, 0x4392);
    write_cmos_sensor(0x2180, 0x760E);
    write_cmos_sensor(0x2182, 0x4130);
    write_cmos_sensor(0x2184, 0x403F);
    write_cmos_sensor(0x2186, 0x00C3);
    write_cmos_sensor(0x2188, 0x4FE2);
    write_cmos_sensor(0x218A, 0x8320);
    write_cmos_sensor(0x218C, 0x43CF);
    write_cmos_sensor(0x218E, 0x0000);
    write_cmos_sensor(0x2190, 0xF0B2);
    write_cmos_sensor(0x2192, 0xFFBF);
    write_cmos_sensor(0x2194, 0x2004);
    write_cmos_sensor(0x2196, 0x9382);
    write_cmos_sensor(0x2198, 0xC314);
    write_cmos_sensor(0x219A, 0x2003);
    write_cmos_sensor(0x219C, 0x12B0);
    write_cmos_sensor(0x219E, 0xCAB0);
    write_cmos_sensor(0x21A0, 0x3C02);
    write_cmos_sensor(0x21A2, 0x12B0);
    write_cmos_sensor(0x21A4, 0xC90A);
    write_cmos_sensor(0x21A6, 0x42A2);
    write_cmos_sensor(0x21A8, 0x7324);
    write_cmos_sensor(0x21AA, 0x4130);
    write_cmos_sensor(0x21AC, 0x42D2);
    write_cmos_sensor(0x21AE, 0x8320);
    write_cmos_sensor(0x21B0, 0x00C3);
    write_cmos_sensor(0x21B2, 0x9382);
    write_cmos_sensor(0x21B4, 0xC314);
    write_cmos_sensor(0x21B6, 0x201B);
    write_cmos_sensor(0x21B8, 0x120B);
    write_cmos_sensor(0x21BA, 0x120A);
    write_cmos_sensor(0x21BC, 0x1209);
    write_cmos_sensor(0x21BE, 0x1208);
    write_cmos_sensor(0x21C0, 0x1207);
    write_cmos_sensor(0x21C2, 0x1206);
    write_cmos_sensor(0x21C4, 0x93C2);
    write_cmos_sensor(0x21C6, 0x82A0);
    write_cmos_sensor(0x21C8, 0x240B);
    write_cmos_sensor(0x21CA, 0x0800);
    write_cmos_sensor(0x21CC, 0x731C);
    write_cmos_sensor(0x21CE, 0x4F0F);
    write_cmos_sensor(0x21D0, 0x0900);
    write_cmos_sensor(0x21D2, 0x731C);
    write_cmos_sensor(0x21D4, 0x4030);
    write_cmos_sensor(0x21D6, 0xC168);
    write_cmos_sensor(0x21D8, 0x4130);
    write_cmos_sensor(0x21DA, 0x0900);
    write_cmos_sensor(0x21DC, 0x731C);
    write_cmos_sensor(0x21DE, 0x3FFA);
    write_cmos_sensor(0x21E0, 0x0900);
    write_cmos_sensor(0x21E2, 0x732C);
    write_cmos_sensor(0x21E4, 0x425F);
    write_cmos_sensor(0x21E6, 0x0788);
    write_cmos_sensor(0x21E8, 0x4030);
    write_cmos_sensor(0x21EA, 0xC2BA);
    write_cmos_sensor(0x21EC, 0x4130);
    write_cmos_sensor(0x21EE, 0x1292);
    write_cmos_sensor(0x21F0, 0xC008);
    write_cmos_sensor(0x21F2, 0x4130);
    write_cmos_sensor(0x21F4, 0x4392);
    write_cmos_sensor(0x21F6, 0x732A);
    write_cmos_sensor(0x21F8, 0x1292);
    write_cmos_sensor(0x21FA, 0xC006);
    write_cmos_sensor(0x21FC, 0x4F0F);
    write_cmos_sensor(0x21FE, 0x425F);
    write_cmos_sensor(0x2200, 0x82A1);
    write_cmos_sensor(0x2202, 0xF25F);
    write_cmos_sensor(0x2204, 0x00C1);
    write_cmos_sensor(0x2206, 0xF35F);
    write_cmos_sensor(0x2208, 0x2406);
    write_cmos_sensor(0x220A, 0x425F);
    write_cmos_sensor(0x220C, 0x00C0);
    write_cmos_sensor(0x220E, 0xF37F);
    write_cmos_sensor(0x2210, 0x522F);
    write_cmos_sensor(0x2212, 0x4F82);
    write_cmos_sensor(0x2214, 0x7324);
    write_cmos_sensor(0x2216, 0x425F);
    write_cmos_sensor(0x2218, 0x82D4);
    write_cmos_sensor(0x221A, 0xF35F);
    write_cmos_sensor(0x221C, 0x4FC2);
    write_cmos_sensor(0x221E, 0x01B3);
    write_cmos_sensor(0x2220, 0x4130);
    write_cmos_sensor(0x2222, 0x42D2);
    write_cmos_sensor(0x2224, 0x82A1);
    write_cmos_sensor(0x2226, 0x00C2);
    write_cmos_sensor(0x2228, 0x1292);
    write_cmos_sensor(0x222A, 0xC040);
    ...
    write_cmos_sensor(0x3238, 0xFE22);
    write_cmos_sensor(0x323A, 0xFD16);
    write_cmos_sensor(0x323C, 0xFCAA);
    write_cmos_sensor(0x3246, 0xFDAC);
    write_cmos_sensor(0x3248, 0xCDB0);
    write_cmos_sensor(0x324E, 0xFD84);
...
{
	LOG_DEBUG("E capture, currefps = %d\n",currefps);
	if( currefps == 300 )
	{
		//Sensor Information////////////////////////////
		//Sensor	  : Hi-846
...
// [LGE_UPDATE_S] [kyunghun.oh@lge.com] [2017-09-18] Creation of node for camera module identification.
                    if(hi846_read_eepromVendorID() != 0)
                        LOG_DEBUG("[HI846] vendor id is different!! you should check the EEPROM or Module hardware\n");
                    g_mainSensor = *sensor_id;
// [LGE_UPDATE_E] [kyunghun.oh@lge.com] [2017-09-18] Creation of node for camera module identification.
					return ERROR_NONE;
				}
...
static kal_uint32 open(void)
{
	...
	LOG_DEBUG("[open]: PLATFORM:MT6735,MIPI 4LANE\n");
        ...
        case SENSOR_FEATURE_GET_SENSOR_VIEWANGLE:
            {
                ...
                *pHorFOV = (0x44)<<16 | (0x44); // 16:9 = 68, 4:3 = 68 // (68)<<16 | (68)   //68 degree
                *pVerFOV = (0x29)<<16 | (0x29);
