...
#include "hi556mipiraw_Sensor_qh_sub.h"
...
#define LOG_1 LOG_INF("hi556_qh_sub,MIPI 2LANE\n")
...
static imgsensor_info_struct imgsensor_info = { 
	.sensor_id = HI556_SENSOR_ID_QH_SUB,//Sensor ID Value: 0x30C8//record sensor id defined in Kd_imgsensor.h
	/* HI556_SENSOR_ID_QH_SUB is configed as 0x559 in kd_imgsensor.h */
...
static void set_mirror_flip(kal_uint8 image_mirror)
{
	...
	switch (image_mirror) {
		case IMAGE_NORMAL:
			write_cmos_sensor(0x000e,0X00); //Normal
			break;
		case IMAGE_H_MIRROR:
			write_cmos_sensor(0x000e,0X01); //H_Mirror
			break;
		case IMAGE_V_MIRROR:
			write_cmos_sensor(0x000e,0X02); //V_Mirror	
			break;
		case IMAGE_HV_MIRROR:
			write_cmos_sensor(0x000e,0X03); //HV_Mirror
			break;
		default:
...
UINT32 HI556_MIPI_RAW_QH_SUB_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
