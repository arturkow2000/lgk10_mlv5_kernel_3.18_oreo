 ...
 *    info : 5M front camera  module vendor: Sunny
 *
 *------------------------------------------------------------------------------
...
static imgsensor_info_struct imgsensor_info = { 
	...
	.i2c_addr_table = {0x30, 0xff},//20,5a
};
	...
	while(imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			*sensor_id = return_sensor_id();
            ...
            strcpy(front_sensor_name, "s5k5e8_sunny");
            g_subSensor = *sensor_id;
				return ERROR_NONE;
			}	
		...
		case SENSOR_FEATURE_GET_SENSOR_VIEWANGLE:
			{
				...
				*pHorFOV = (0x42)<<16 | (0x42); // 16:9 = 66, 4:3 = 66 // (66)<<16 | (66)   //66 degree
				*pVerFOV = (0x29)<<16 | (0x29); // 16:9 = 41, 4:3 = 41 // (41)<<16 | (41)   //41 degree
