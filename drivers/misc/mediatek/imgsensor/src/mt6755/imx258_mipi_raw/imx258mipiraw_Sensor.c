...
//LGE_UPDATE_S [kyunghun.oh@lge.com] 2016/10/10, add model define at color order and mirror_flip
...
#endif
//LGE_UPDATE_E [kyunghun.oh@lge.com] 2016/10/10, add model define at color order and mirror_flip
...
static kal_uint16 gain2reg(const kal_uint16 gain)
{
    ...
    for (i = 0; i < (IMX258MIPI_MaxGainIndex-1); i++) {
...
static void sensor_init(void)
{
    ...
    write_cmos_sensor(0x3052,0x00); //LGE_UPDATE [yonghwan.lym@lge.com] 2016/10/24, disable the PDAF compensation value
    ...
    write_cmos_sensor(0x7FFA,0x00); //LGE_UPDATE [yonghwan.lym@lge.com] 2016/10/24, disable the PDAF compensation value
    ...
    write_cmos_sensor(0x7B25,0x00); //LGE_UPDATE [yonghwan.lym@lge.com] 2016/10/24, disable the PDAF compensation value
