...
//static struct i2c_board_info __initdata i2c_k303b={ I2C_BOARD_INFO(K303B_DEV_NAME, K303B_I2C_ADDRESS>>1)};
/*----------------------------------------------------------------------------*/
...
{
	const char *name = "mediatek,k303b-mag";
