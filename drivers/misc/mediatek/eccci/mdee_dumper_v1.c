...
err_exit:
	...
	if (debug_info && debug_info->type == MD_EX_TYPE_C2K_ERROR && debug_info->fatal_error.err_code1 == MD_EX_C2K_FATAL_ERROR)
		CCCI_ERROR_LOG(md_id, KERN, "C2K EE, No need trigger DB\n");
	else if (debug_info && debug_info->type == CC_MD1_EXCEPTION)
