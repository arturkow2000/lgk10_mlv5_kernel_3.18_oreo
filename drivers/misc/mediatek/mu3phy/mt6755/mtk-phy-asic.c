...
#ifdef CONFIG_LGE_USB_TYPE_C	// HOST mode connection driving capacity : 8 -> 4
            U3PhyWriteField32((phys_addr_t) (uintptr_t) U3D_USBPHYACR1, RG_USB20_VRT_VREF_SEL_OFST, RG_USB20_VRT_VREF_SEL, 2);
            U3PhyWriteField32((phys_addr_t) (uintptr_t) U3D_USBPHYACR1, RG_USB20_TERM_VREF_SEL_OFST, RG_USB20_TERM_VREF_SEL, 2);
#endif
...
#ifdef CONFIG_LGE_USB_TYPE_C // HOST mode disconnection driving capacity : 4 -> 8
			U3PhyWriteField32((phys_addr_t) (uintptr_t) U3D_USBPHYACR1, RG_USB20_VRT_VREF_SEL_OFST, RG_USB20_VRT_VREF_SEL, 4);
			U3PhyWriteField32((phys_addr_t) (uintptr_t) U3D_USBPHYACR1, RG_USB20_TERM_VREF_SEL_OFST, RG_USB20_TERM_VREF_SEL, 4);
#endif
			/* Set RG_SUSPENDM to 1 */
			U3PhyWriteField32((phys_addr_t) (uintptr_t) U3D_U2PHYDTM0, RG_SUSPENDM_OFST,
				RG_SUSPENDM, 0);
...
#else
#ifdef CONFIG_MACH_MT6750_TH8	//set init usb(device and otg) default drivering capability 8->14
	os_printk(K_INFO, "%s- USB PHY Driving Tuning Mode 1 Settings.\n", __func__);
	U3PhyWriteField32((phys_addr_t) (uintptr_t) U3D_USBPHYACR1, RG_USB20_VRT_VREF_SEL_OFST,
...
void Charger_Detect_Init(void)
{
	...
	if (epack_get_usb_path() == EPACK_USB_PATH_EPACK) {
		os_printk(K_DEBUG, "epack don't do BC1.2 init\n");
		return;
	}
#endif
...
#ifdef CONFIG_INPUT_EPACK
	if (epack_get_usb_path() == EPACK_USB_PATH_EPACK) {
		os_printk(K_DEBUG, "epack don't do BC1.2 release\n");
		return;
	}
#endif
		/* turn on USB reference clock. */
