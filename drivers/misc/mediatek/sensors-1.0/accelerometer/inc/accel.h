...
#define ACC_PR_ERR(fmt, args...)	printk(ACC_TAG"%s %d : "fmt, __func__, __LINE__, ##args)
#define ACC_LOG(fmt, args...)		printk(ACC_TAG"%s %d : "fmt, __func__, __LINE__, ##args)
#define ACC_VER(fmt, args...)		printk(ACC_TAG"%s %d : "fmt, __func__, __LINE__, ##args)

#define OP_ACC_DELAY	0X01
#define	OP_ACC_ENABLE	0X02
#define	OP_ACC_GET_DATA	0X04

#define ACC_INVALID_VALUE INT_MAX
