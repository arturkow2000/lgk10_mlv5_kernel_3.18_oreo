...
#define ACC_CALIBRATION_PATH 	"/vendor/persist-lg/sensor/accel_cal_data.txt"
#define COMPATIABLE_NAME 		"mediatek,bmi160_acc"
#define BMI160_DEV_NAME        	"bmi160_acc"

#define GSE_TAG                  "[bmi160_acc] "
...
#define BMI160_ACC_CAL_FAIL 1
#define BMI160_ACC_FLAT_FAIL 2
...
#define BMI160_ACC_AXIS_OLD_X		3
#define BMI160_ACC_AXIS_OLD_Y		4
#define BMI160_ACC_AXIS_OLD_Z		5
...
/*STEP MODE*/
#define STEP_NORMAL_MODE	(1)
#define STEP_SENSITIVE_MODE	(2)
#define STEP_ROBUST_MODE	(3)
...
/**************************************************************/
/**\name Self_Test LENGTH, POSITION AND MASK    */
/**************************************************************/
/* selftest Description - Reg Addr --> 0x6d, Bit --> 0...1*/
...
/* selftest Description - Reg Addr --> 0x6d, Bit --> 2*/
...
/* selftest Description - Reg Addr --> 0x6d, Bit --> 3*/
#define BMI160_USER_ACC_SELF_TEST_AMP__POS		(3)
#define BMI160_USER_ACC_SELF_TEST_AMP__LEN		(1)
#define BMI160_USER_ACC_SELF_TEST_AMP__MSK		(0x08)
#define BMI160_USER_ACC_SELF_TEST_AMP__REG		BMI160_USER_SELF_TEST_ADDR
...
#define BMI160_DEFECT_LIMIT_XY 2007
#define BMI160_DEFECT_LIMIT_Z1 5899
#define BMI160_DEFECT_LIMIT_Z2 10485
#define BMI160_SHAKING_DETECT_THRESHOLD 825
#define BMI160_FAST_CALIB_TILT_LIMIT 1500
