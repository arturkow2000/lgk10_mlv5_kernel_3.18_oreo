...
#ifdef SW_CALIBRATION
	struct k2hh_i2c_data *priv = obj_i2c_data;
...
#define K2HH_AXIS_Z          2
	...
	if((err = hwmsen_write_block(k2hh_i2c_client, /*obj->client,*/ MC3210_REG_OFSX, obj->offset, MC3210_AXES_NUM)))
	{
...
static int k2hh_ReadSensorData(struct i2c_client *client, char *buf, int bufsize)
{
	...
	int res = 0;
	struct k2hh_i2c_data *obj = obj_i2c_data;
	//client = k2hh_i2c_client;//obj->client;
...
{
	struct k2hh_i2c_data *data = obj_i2c_data;
...
static int k2hh_acc_batch(int flag, int64_t samplingPeriodNs, int64_t maxBatchReportLatencyNs)
{
	return 0;
}
static int k2hh_acc_flush(void)
{
...
static int k2hh_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	ctl.batch  = k2hh_acc_batch;
	ctl.flush  = k2hh_acc_flush;
	...
	k2hh_delete_attr(&(k2hh_acc_init_info.platform_diver_addr->driver));
