...
#ifndef ICM406XX_SHARE_H
#define ICM406XX_SHARE_H

#include "icm406xx_share_interface.h"

#define ICM406XX_AXIS_X    0
#define ICM406XX_AXIS_Y    1
#define ICM406XX_AXIS_Z    2
#define ICM406XX_AXIS_NUM    3
#define ICM406XX_DATA_LEN    6
#define ICM406XX_BUFSIZE    60
#define ICM406XX_LPM_MAX_RATE 200

enum icm406xx_sensor_type {
    ICM406XX_SENSOR_TYPE_ACC,
    ICM406XX_SENSOR_TYPE_GYRO,
    ICM406XX_SENSOR_TYPE_SC,
    ICM406XX_SENSOR_TYPE_SD,
    ICM406XX_SENSOR_TYPE_SMD,
    ICM406XX_SENSOR_TYPE_MAX
};

enum icm406xx_interrupt_type {
    ICM406XX_INT_TYPE_UI_AGC_RDY,
    ICM406XX_INT_TYPE_FIFO_FULL,
    ICM406XX_INT_TYPE_FIFO_THS,
    ICM406XX_INT_TYPE_UI_DRDY,
    ICM406XX_INT_TYPE_RESET_DONE,
    ICM406XX_INT_TYPE_UI_FSYNC,
    ICM406XX_INT_TYPE_SMD,
    ICM406XX_INT_TYPE_WOM,
    ICM406XX_INT_TYPE_MAX
};

/* To enable selftest, activate this feature */
#define ICM406XX_SELFTEST		
...
extern void icm406xx_share_set_sensor_power_mode(int paramSensor,
    u8 paramPower);
extern u8 icm406xx_share_get_sensor_power_mode(int paramSensor);
extern bool icm406xx_share_get_sensor_power(int paramSensor);
extern bool icm406xx_share_any_accel_based_sensor_is_on(void);
extern int icm406xx_share_ChipSoftReset(void);
extern int icm406xx_share_SetPowerMode(int sensor_type, bool enable);
extern int icm406xx_share_EnableInterrupt(u8 int_type, bool enable);
extern int icm406xx_share_EnableSensor(int sensor_type, bool enable);
extern int icm406xx_share_ReadChipInfo(char *buf, int bufsize);
extern int icm406xx_share_SetSampleRate(int sensor_type,
    u64 delay_ns, bool force_1khz);

#endif /* ICM406XX_SHARE_H */
