...
#define SITUATION_FUN(f)		        printk(SITUATION_TAG"%s\n", __func__)
#define SITUATION_PR_ERR(fmt, args...)	printk(SITUATION_TAG"%s %d : "fmt, __func__, __LINE__, ##args)
#define SITUATION_LOG(fmt, args...)		printk(SITUATION_TAG fmt, ##args)
#define SITUATION_VER(fmt, args...)		printk(SITUATION_TAG"%s: "fmt, __func__, ##args)
