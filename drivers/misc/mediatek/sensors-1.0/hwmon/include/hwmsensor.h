...
#define SENSOR_TYPE_PHONE_TILT_GESTURE				70

//#ifdef CONFIG_LGE_SENSOR_SLOPE_DETECTOR
#define SENSOR_TYPE_SLOPE_DETECTOR				51
//#endif // CONFIG_LGE_SENSOR_SLOPE_DETECTOR
...
#define ID_PHONE_TILT_GESTURE           (ID_BASE+SENSOR_TYPE_PHONE_TILT_GESTURE-1)

//#ifdef CONFIG_LGE_SENSOR_SLOPE_DETECTOR
#define ID_SLOPE_DETECTOR     		    (ID_BASE+SENSOR_TYPE_SLOPE_DETECTOR-1)
//#endif // CONFIG_LGE_SENSOR_SLOPE_DETECTOR

/* end sensor ID */
#define ID_SENSOR_MAX_HANDLE			(ID_BASE + SENSOR_TYPE_SLOPE_DETECTOR)
...
#define LGE_SENSOR_TYPE_BASE              499898100
#define BSTEXT_SENSOR_TYPE_PHONE_TILT_GESTURE (LGE_SENSOR_TYPE_BASE + 18)

//#ifdef CONFIG_LGE_SENSOR_SLOPE_DETECTOR
#define BSTEXT_SENSOR_TYPE_SLOPE_DETECTOR (LGE_SENSOR_TYPE_BASE + 6)
//#endif // CONFIG_LGE_SENSOR_SLOPE_DETECTOR

#define SENSOR_PHONE_TILT_GESTURE       (1 << ID_PHONE_TILT_GESTURE)

//#ifdef CONFIG_LGE_SENSOR_SLOPE_DETECTOR
#define SENSOR_SLOPE_DETECTOR                (1 << ID_SLOPE_DETECTOR)
//#endif
