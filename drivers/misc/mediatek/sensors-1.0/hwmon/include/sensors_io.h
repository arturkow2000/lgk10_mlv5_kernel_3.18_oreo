...
/* Legacy Interface in LV5 k303b-mag */
...
/*-------------------LGE add-------------------------------------------*/
#define ALSPS_GET_DEVICEID			_IOR(ALSPS, 0x80, int)
#define ALSPS_GET_CALI				ALSPS_IOCTL_GET_CALI
#define ALSPS_SET_CALI				ALSPS_IOCTL_SET_CALI
