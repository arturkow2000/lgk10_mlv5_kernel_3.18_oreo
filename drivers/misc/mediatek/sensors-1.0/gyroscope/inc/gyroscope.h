...
#define GYRO_PR_ERR(fmt, args...)	printk(GYRO_TAG fmt, ##args)
#define GYRO_LOG(fmt, args...)		printk(GYRO_TAG fmt, ##args)
#define GYRO_VER(fmt, args...)		printk(GYRO_TAG fmt, ##args)
#define GYRO_INFO(fmt, args...)		printk(GYRO_TAG fmt, ##args)

#define OP_GYRO_DELAY	0X01
#define	OP_GYRO_ENABLE	0X02
#define	OP_GYRO_GET_DATA	0X04
#define GYRO_INVALID_VALUE INT_MAX
