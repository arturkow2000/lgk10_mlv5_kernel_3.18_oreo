...
#if defined (CONFIG_SW49106_FHDPLUS_DSI_VDO_LGD_CV5) || defined (CONFIG_SW49107_LGD_FHDPLUS_DSI_CMD_CV7A)
...
void rdma_set_ultra_l(unsigned int idx, unsigned int bpp, void *handle, golden_setting_context *p_golden_setting)
{
	...
	if (p_golden_setting == NULL) {
		...
		temp_golden_setting.dst_height	= 2160;
		temp_golden_setting.rdma_width	= 1080;
		temp_golden_setting.rdma_height	= 2160;
