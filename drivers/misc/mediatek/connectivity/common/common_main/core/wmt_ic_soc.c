...
static UINT8 WMT_BT_TSSI_FROM_WIFI_CONFIG_CMD[] = {
		0x01, 0x02, 0x24, 0x00, 0x0D, 0x01, 0x1E, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
static INT32 mtk_wcn_soc_sw_init(P_WMT_HIF_CONF pWmtHifConf)
{
	...
	WMT_INFO_FUNC("bt_tssi_from_wifi=%d, bt_tssi_target=%d, bt_tssi_average_cal_value[]=[%02X,%02X,%02X,%02X]\n",
		pWmtGenConf->bt_tssi_from_wifi, pWmtGenConf->bt_tssi_target, pWmtGenConf->bt_tssi_average_cal_value[0],
		pWmtGenConf->bt_tssi_average_cal_value[1], pWmtGenConf->bt_tssi_average_cal_value[2],
		pWmtGenConf->bt_tssi_average_cal_value[3]);
	...
	if (pWmtGenConf->bt_tssi_from_wifi == 1) {
		...
		osal_memcpy(&WMT_BT_TSSI_FROM_WIFI_CONFIG_CMD[8], pWmtGenConf->bt_tssi_average_cal_value, 32);
