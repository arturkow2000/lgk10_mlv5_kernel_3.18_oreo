...
#if defined(LG4894_HD720_DSI_VDO)
	&lg4894_hd720_dsi_vdo_drv,
#endif

#if defined(TD4100_HD720_DSI_VDO_TOVIS_LV5)
	&td4100_hd720_dsi_vdo_tovis_lv5_drv,
#endif

#if defined(LG4894_HD720_DSI_VDO_TOVIS_CV3_SPR)
	&lg4894_hd720_dsi_vdo_tovis_cv3_spr_drv,
#endif

#if defined(TD4100_HD720_DSI_VDO_TOVIS_LV7)
	&td4100_hd720_dsi_vdo_tovis_lv7_drv,
#endif
...
#if defined(SW49107_TOVIS_FHDPLUS_DSI_CMD_CV7A)
        &sw49107_tovis_fhdplus_dsi_cmd_cv7a_lcm_drv,
#endif

#if defined(SW49107_LGD_HDPLUS_DSI_CMD_CV7A)
        &sw49107_lgd_hdplus_dsi_cmd_cv7a_lcm_drv,
#endif

#if defined(SW49107_TOVIS_HDPLUS_DSI_CMD_CV7A)
        &sw49107_tovis_hdplus_dsi_cmd_cv7a_lcm_drv,
#endif
...
#endif
#if defined(HX8394A_GUOXIAN_INX_A026_ZAL2017)
	&hx8394a_guoxian_inx_a026_zal2017_lcm_drv,
#endif
#if defined(HX8394A_GUOXIAN_INX_B026_ZAL2017)
	&hx8394a_guoxian_inx_b026_zal2017_lcm_drv,
#endif
#if defined(JD9366_DIJING_CPT_ZAL2017)
	&jd9366_dijing_cpt_zal2017_lcm_drv,
#endif
};
