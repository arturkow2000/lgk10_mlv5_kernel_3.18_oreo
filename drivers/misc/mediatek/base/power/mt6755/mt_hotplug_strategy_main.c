...
#if defined(CONFIG_SCHED_NEURAL_NETWORKS) && (defined(CONFIG_MACH_MT6750_LV5) || defined(CONFIG_MACH_MT6750_LV7))
	.pa_hps_enabled = ENABLE_PA_HPS_SCHED_NN,
#else
	.pa_hps_enabled = ENABLE_PA_HPS,
#endif
#endif
};
